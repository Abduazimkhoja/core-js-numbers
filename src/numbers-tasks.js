 ...
 *   0    => 0
 */
const getCircleCircumference = (r) => {
  return r * Math.PI * 2;
};
...
//   n > 1 &&
//   ([2, 3, 5, 7].includes(n) ||
//     ![2, 3, 5, 7].some((factor) => n % factor === 0));
 ...
 * -5.5 => -5
 */
const getIntegerPartNumber = (number) => {
 ...
 * 0.1, 0.2, 0.3 => 0.6
 */
const getSumOfNumbers = (x1, x2, x3) => {
  const sum = x1 + x2 + x3;
